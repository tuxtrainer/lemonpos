...
class ProductEditor : public KDialog
{
  ...
  public:
    ...
    void    disableCode()              { ui->editCode->setReadOnly(true);ui->editCode->setEnabled(false); modifyCode=false; };
    void    enableCode()               { ui->editCode->setReadOnly(false);ui->editCode->setEnabled(true); modifyCode=true; };
...
private slots:
    ...
    void    showBtns();
    void    toggleIndividual(bool checked);
